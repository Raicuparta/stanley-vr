...
namespace UnityEditor.XR.OpenXR.Features.RuntimeDebugger
{
    ...
    internal class RuntimeDebuggerWindow : EditorWindow
    {
        ...
        private class PlayerConnectionGUIUtility
        {
            public static IConnectionState GetConnectionState(RuntimeDebuggerWindow runtimeDebuggerWindow)
            {
        ...
        private class PlayerConnectionGUILayout
        {
            public static void ConnectionTargetSelectionDropdown(IConnectionState connectionState)
            {
                throw new System.NotImplementedException();
            }
        }
